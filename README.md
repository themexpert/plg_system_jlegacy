## Joomla - Legacy class map
Joomla 5 has removed the old way of doing things, and this plugin will add it back so your old extensions will work again.

## Installation
1. Download the repository zip
2. Install in Joomla 5
3. Enable it from plugin
* no extra configuration is required.

### Lists of legacy class map
Source: Joomla 4
```php
